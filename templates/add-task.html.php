<section class="container py-5">
    <h1 class="text-center my-4">Ajouter une tâche</h1>
    <div class="my-4">
        ...
        <form action="" method="POST" class="row gy-3">
            <div class="col-12">
                <div class="form-group mb-4">
                    ...
                    <input type="text" name="task_name" id="task_name" class="form-control" placeholder="Faire les courses" required>
            ...
            <div class="mb-4">
                <button type="submit" class="btn btn-primary" name="add_task_submit" id="add_task_submit" title="Ajouter">Ajouter</button>
            </div>
        </form>
    </div>
</section>